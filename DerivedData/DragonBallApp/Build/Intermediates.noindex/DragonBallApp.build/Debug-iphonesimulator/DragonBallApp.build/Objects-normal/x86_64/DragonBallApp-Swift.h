...
#ifndef DRAGONBALLAPP_SWIFT_H
#define DRAGONBALLAPP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="DragonBallApp",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC13DragonBallApp11AppDelegate")
...
SWIFT_CLASS("_TtC13DragonBallApp8CellView")
...
SWIFT_CLASS("_TtC13DragonBallApp20DetailViewController")
...
SWIFT_CLASS("_TtC13DragonBallApp18HomeViewController")
...
@interface HomeViewController (SWIFT_EXTENSION(DragonBallApp)) <UICollectionViewDataSource, UICollectionViewDelegateFlowLayout>
...
SWIFT_CLASS("_TtC13DragonBallApp13SceneDelegate")
...
SWIFT_CLASS("_TtC13DragonBallApp20SplashViewController")
